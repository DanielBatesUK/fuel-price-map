...
import getStations from "../models/get_stations.js";
import getFuelPrices from "../models/get_fuel_prices.js";
...
router.get("/stations", async (req, res) => {
  try {
    ...
    const stationResults = await getStations(req.reqId, north, east, south, west);
...
router.get("/prices", async (req, res) => {
  try {
    ...
    const priceResults = await getFuelPrices(req.reqId, node_id);
